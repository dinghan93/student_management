                ...
                <td valign=top align=middle>
					...
					<table id=child2 style="display: none" cellspacing=0 cellpadding=0  width=150 border=0>
						<tr height=20>
                            ...
                            <td>
								<a class=menuchild  href="/Educational/student/stuOperation"  target="right">学生管理</a>
							</td>
						</tr>
                        <tr height=4>
                            <td colspan=2></td>
                    ...
                    <table id=child7 style="display: none" cellspacing=0 cellpadding=0  width=150 border=0>
                        <tr height=20>
                            ...
                            <td>
                                <a class=menuchild  href="/power/user/usersOperation?method=getAll"  target="right">用户管理</a>
                            </td>
                        </tr>
                        ...
                        <tr height=20>
                            ...
                            <td>
                                <a class=menuchild  href="/power/role/roleOperation?method=getAll"  target="right">角色管理</a>
                            </td>
                        </tr>
