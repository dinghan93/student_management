...
<table border="1" width="100%" class="table_a">
						...
						<ul>
                            <c:forEach items="${menuList}" var="m">
                                <li>
                                    ...
                                    <input type="checkbox" ${flag==true?'checked':''} name="menuid" class="pMenu" value="${m.menuid}"/>${m.menuname}
                                    <ul>
                                        <c:forEach items="${m.subMenus}" var="sub">
                                            ...
                                            <li>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" ${flag==true?'checked':''} name="menuid" class="sMenu" value="${sub.menuid}"/>${sub.menuname}</li>
                                        </c:forEach>
                                    </ul>
                                </li>
                            </c:forEach>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="rolestate" ${role.rolestate==1?'checked':''} value="1" />启用 <input type="radio" name="rolestate" ${role.rolestate==0?'checked':''} value="0" />禁用
                    </td>
                </tr>
