    ...
    <form action="list.jsp" method="post">
        <table border="1" width="100%" class="table_a">
            <tr width="120px;">
                ...
                <td>
                    <input type="text" name="rolename" value="${role.rolename}" disabled/>
                </td>
            </tr>
                        ...
                        <c:forEach items="${menuList}" var="m">
                            <li>
                                ...
                                <input type="checkbox" ${flag==true?'checked':''} name="menuid" class="pMenu"
                                       value="${m.menuid}" disabled/>${m.menuname}
                                <ul>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="state" ${role.rolestate==1?'checked':''} value="1"
                           disabled/>启用 <input type="radio" name="state" ${role.rolestate==0?'checked':''}
                                               value="0" disabled/>禁用
                </td>
            </tr>
